...
public class Stone extends Enemy {
	...
	/**
	 * Stone 객체의 움직임을 변경하는 메소드입니다. 쓰레드를 생성하여 일정 시간마다 움직임 상태와 속도를 변경합니다.
	 */
	...
	/**
	 * Stone 객체의 움직임 방향을 결정하는 메소드입니다. 쓰레드를 생성하여 움직임 상태에 따라 객체의 위치를 변경합니다.
	 */
